/**
 * PL Defencsing Template
 */
class PlDefending extends LeagueTemplate {

    shotsXGAgainstTitle = 'shots/xG Against Tier';
    ...
    spShotsSpXGTitle = 'SP shots/SP xG Tier';
    spShotsSpXGId = 'spshots-spxG-tier';
    spXGGxGTitle = 'SP xG/G-xG Tier';
    spXGGxGId = 'spxG-G-xG-tier';
    xAAxAGTitle = 'xA/A-xAG Tier';
    xAAxAGId = 'xA-A-xAG-tier';
    attProgressiveTitle = 'Pass Att/Progressive Tier';
    attProgressiveId = 'att-progressive-tier';
    passingAttTitle = 'Pass Att';
    passingAttId = 'passing-att';
    passingAttCmpTitle = 'Pass Att/Cmp';
    passingAttCmpId = 'passing-att-cmp';
    keyPassTitle = 'Key Pass';
    keyPassId = 'key-pass';
    passingFinal3rdTitle = 'Pass into final 3rd';
    passingFinal3rdId = 'passing-final-third';
    passingPenAreaTitle = 'Pass into Pen Area';
    passingPenAreaId = 'passing-pen-area';
    crossPenAreaTitle = 'Cross into Pen Area';
    crossPenAreaId = 'cross-pen-area';
    scaTypeTitle = 'SCA Types';
    scaTypeId = 'sca-type';
    gcaTypeTitle = 'GCA Types';
    gcaTypeId = 'gca-type';
    gcaNetworkTitle = 'GCA Network';
    gcaNetworkId = 'gca-network';
    touchesTitle = 'Touches';
    touchesId = 'touches';
    takeOnsTitle = 'Take-Ons Att/Succ Tier';
    takeOnsId = 'take-ons-tier';
    carriesPrgCarriesTitle = 'Prg Carries Tier';
    carriesPrgCarriesId = 'carries-prgCarries-tier';
    carriesCarriesIntoFinal3rdTitle = 'Carries into final 3rd Tier';
    carriesCarriesIntoFinal3rdId = 'carries-intoFinal3rd-tier';
    carriesCarriesIntoPenAreaTitle = 'Carries into Pen Area Tier';
    carriesCarriesIntoPenAreaId = 'carries-intoPenArea-tier';
    sequeneTimeTitle = 'Sequence Time';
    sequenceTimeId = 'sequence-time';
    sequenceStyleTitle = 'Sequence Style';
    ...
    */
    ...
    renderCharts() {
        ...
        Common.addChartDivs([
            {
                title: this.shotsXGAgainstTitle,
                chartId: this.shotsXGAgainstId
            },
            {
    ...
    createData() {
        ...
        // load spreadsheet expected goals against
    ...
    /**
     * create expected goals against chart(Override)
     */
    createExpectedGoalsAgainstChart() {

        // create expected goals against chart
        if (this.expectedAgainstData['isNoData']) {
            return;
        }
